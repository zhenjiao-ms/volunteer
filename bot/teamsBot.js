...
class TeamsBot extends TeamsActivityHandler {
        ...
        case "welcome": {
          ...
          card.onExecuteAction = (action) => {
            if (action instanceof SubmitAction) {
                ...
                //await context.sendActivity("created")
            }
        }
                  break;
        }
  ...
  async onAdaptiveCardInvoke(context, invokeValue) {
    ...
    if (invokeValue.action.verb === "create") {
      let name = invokeValue. action.data["name"]
      let desc = invokeValue.action.data["desc"]
